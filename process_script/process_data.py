...
def process_bw_udls_dataframe(df):
     sub_component_latencies = {}
     sub_component_latencies['c_udla'] = get_durations(df, 10030, 1000, group_by_columns=['node_id'], duration_name='c_udla')
     sub_component_latencies['c_udlb'] = get_durations(df, 20020, 1000, group_by_columns=['node_id'], duration_name='c_udlb')
     sub_component_latencies['udla_d'] = get_durations(df, 30030, 10031, group_by_columns=['node_id'], duration_name='udla_d')
     sub_component_latencies['udlb_d'] = get_durations(df, 30030, 20100, group_by_columns=['node_id'], duration_name='udlb_d')
...
def process_udls_dataframe(df):
     ...
     sub_component_latencies['udlB'] = get_durations(df, 20100, 20020, group_by_columns=['node_id'], duration_name='udlB')
