...
node_names=("TY373@d7525-10s10337.wisc.cloudlab.us" \
            ...
            "TY373@d7525-10s10333.wisc.cloudlab.us" \
...
monoclient_file_path="${local_cfg_directory}/${monoclient_py}"
scp "${monoclient_file_path}" "${last_remote_node_name}:${remote_cfg_directory}/${last_node_id}/pipeline_client/"