...
# Config
# ------------------------------------------
BASE_DIR = "ppl2/APR14/sendrate_12"  # directory containing n0/, n1/, ...
...
def main():
    ...
    if all_durations:
        ...
        print(f"Latency (s)       : mean={latency['mean']:.4f}, p50={latency['p50']:.4f}, p90={latency['p90']:.4f}, p99={latency['p99']:.4f}, p95={latency['p95']:.4f}, p5={latency['p5']:.4f}")
    else:
