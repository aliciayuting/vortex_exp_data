...
cluster_size = 4
# Load data
plot_name = f"ppl2_vr_cluster{cluster_size}"
...
plt.errorbar(ray_df['ThroughputMicro'][mask], ray_df['LatencyMedMicro'][mask],
            ...
            label='Ray Serve', color=frame_colors['Ray Microservice'])
...
# plt.title(f"Latency vs Throughput of SpeechSense on Cluster{cluster_size}", fontsize=26, pad=10)
